...
//                System.out.println("Press 4 to View all gyms by area");
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        printBookings(viewAllBookings(email));
                    ...
                    case 3:
                        System.out.println("My Bookings");
                        List<FlipFitBookings> flipFitBookings = viewAllBookings(email);
...
//                        break;
    ...
    private void printBookings(List<FlipFitBookings> viewAllBookings) {
        for (FlipFitBookings flipFitBookings : viewAllBookings) {
            System.out.println("====================");
            System.out.println("bookingId: " + flipFitBookings.getBookingId() + " Gym ID: " + flipFitBookings.getGymId() + " date: " + flipFitBookings.getDate() + " time: " + flipFitBookings.getTime());
 ...
 */
    public List<FlipFitBookings> viewAllBookings(String email) {
        List<FlipFitBookings> myBookings = userServiceOperation.getAllBookings(email);
        return myBookings;
    }
